      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-slate-900 text-white rounded-full font-medium hover:bg-slate-800 transition-colors shadow-sm shadow-slate-900/20 focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:outline-none"
          >
        ...
        <AnimatePresence>
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 group-focus-within:opacity-100 group-focus-within:translate-y-0">
                <button
                  onClick={() => openEditModal(skill)}
                  aria-label={`Edit ${skill.name} skill`}
                  className="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                >
                ...
                <button
                  ...
                  className="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
                >
              ...
              <div className="flex items-center gap-1 mb-5" role="img" aria-label={`Proficiency: ${skill.proficiency} out of 5 stars`}>
                {[1, 2, 3, 4, 5].map(star => (
                  <Star key={star} aria-hidden="true" className={`w-4 h-4 ${star <= skill.proficiency ? 'text-amber-400 fill-amber-400' : 'text-slate-200'}`} />
                ))}
              </div>
