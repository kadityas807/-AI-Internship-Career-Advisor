...
export default function SkillsPage() {
  ...
  const handleDelete = async (skill: any) => {
    if (!user) return;
    if (!window.confirm(`Are you sure you want to delete the "${skill.name}" skill?`)) return;
    try {
            ...
            >
              ...
              <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
                ...
                <button
                  ...
                  className="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-red-500 outline-none"
                >
