        ...
        <AnimatePresence>
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 group-focus-within:translate-y-0 transition-opacity translate-y-2 group-hover:translate-y-0">
                <button
