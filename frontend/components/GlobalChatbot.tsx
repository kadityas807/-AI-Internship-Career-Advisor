          ...
          >
            ...
            <div className="p-4 bg-slate-900 flex justify-between items-center text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-sm font-display tracking-tight">AI Mentor</h2>
              ...
              {isLoading && (
                <div className="flex gap-3">
                  ...
                  <div className="bg-white border border-slate-200 shadow-sm rounded-2xl px-4 py-3 flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-500 font-medium" role="status" aria-live="polite">Thinking...</span>
                  </div>
                </div>
              )}
