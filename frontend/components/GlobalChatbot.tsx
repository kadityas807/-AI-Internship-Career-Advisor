    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-indigo-600 rounded-full shadow-lg shadow-indigo-600/30 flex items-center justify-center text-white z-50 hover:bg-indigo-700 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none transition-colors"
        >
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-slate-900 flex justify-between items-center text-white">
              ...
              <button onClick={() => setIsOpen(false)} aria-label="Close AI Mentor" className="p-1.5 hover:bg-slate-800 rounded-lg focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none transition-colors">
            ...
            <div className="p-3 bg-white border-t border-slate-100">
              <form onSubmit={sendMessage} className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none disabled:opacity-50 transition-colors shadow-sm"
                >
