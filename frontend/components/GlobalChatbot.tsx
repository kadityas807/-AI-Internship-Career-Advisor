    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-indigo-600 rounded-full shadow-lg shadow-indigo-600/30 flex items-center justify-center text-white z-50 hover:bg-indigo-700 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500 outline-none"
        >
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-slate-900 flex justify-between items-center text-white">
              ...
              <button onClick={() => setIsOpen(false)} aria-label="Close AI Mentor" className="p-1.5 hover:bg-slate-800 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none">
                <X className="w-5 h-5 text-slate-400 hover:text-white" />
              </button>
            </div>

            {/* Chat Area */}
            <div role="log" aria-live="polite" className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50">
            ...
            <div className="p-3 bg-white border-t border-slate-100">
              <form onSubmit={sendMessage} className="flex items-center gap-2">
                <label htmlFor="chatbot-input" className="sr-only">Ask me to extract skills...</label>
                <input
                  id="chatbot-input"
                  ref={inputRef}
                  type="text"
                ...
                <button
                  ...
                  className="p-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-50 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none"
                >
