...
/**
 * Implementation component for the GlobalChatbot.
 * Separated from the container to avoid conditional hook calls.
 */
function GlobalChatbotImpl() {
  const { user } = useAuth();
