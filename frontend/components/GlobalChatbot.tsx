        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-slate-900 flex justify-between items-center text-white">
              ...
              <button onClick={() => setIsOpen(false)} aria-label="Close AI Mentor" title="Close AI Mentor" className="p-1.5 hover:bg-slate-800 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none">
